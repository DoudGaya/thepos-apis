    ...
    <div className="animate-in fade-in duration-500">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          {/* Headline */}
          <h1 className="text-5xl sm:text-6xl max-w-4xl w-full lg:text-7xl font-bold tracking-tight">
            <span className="text-zinc-900 dark:text-white">The Future</span>
            <br />
          ...
          {/* Trust Signals */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-6 text-sm text-zinc-500 dark:text-zinc-400">
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl overflow-hidden">
            {/* Background gradient */}
            <div className="absolute inset-0 bg-gradient-to-r from-zinc-900 via-zinc-800 to-zinc-900 dark:from-gray-400 dark:via-zinc-500 dark:to-gray-400" />
